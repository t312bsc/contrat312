const Contrat312 = [
  {
    address: "0x09Afd2732B22Bc52BFf642511d29E9872FFe372C",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint8", name: "_feeDecimals", type: "uint8" },
      { internalType: "uint32", name: "_liquidityFee", type: "uint32" },
    ],
  ...
  {
    inputs: [{ internalType: "uint8", name: "_feeDecimals", type: "uint8" }],
    name: "setFeeDecimals",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "address payable", name: "newx", type: "address" },
    ],
    name: "setx",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address payable", name: "newy", type: "address" },
    ],
    name: "sety",
    outputs: [],
    stateMutability: "nonpayable",
